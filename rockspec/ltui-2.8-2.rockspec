...
build = {
	...
	install = {
		lua = {
			...
			["ltui.base.additions"] = "src/ltui/base/additions.lua",
			...
			["ltui.drawable.canvas"] = "src/ltui/drawable/canvas.lua",
			["ltui.drawable.drawtool"] = "src/ltui/drawable/drawtool.lua",
			["ltui.drawable.linedraw"] = "src/ltui/drawable/linedraw.lua",
